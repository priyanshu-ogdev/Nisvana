...
| **[`ML_DESIGN.md`](ML_DESIGN.md)** | **Complete ML and Inference Design** | Algorithms, model architectures, parameters, dataset mapping and sizes, synchronization contracts, ONNX runtime, frontend/backend telemetry, and SIH release gates. |
